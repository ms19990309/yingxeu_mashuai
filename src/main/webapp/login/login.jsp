    ...
    <script>
        ...
        $(function(){
            ...
            $("#imgVcode").click(function(){
                $("#imgVcode").prop("src","${path}/adminController/code?xx="+new Date().getTime());
            });
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm" method="post">
                            <span id="msgDiv"></span>
                            ...
                            <div class="form-group">
                                ...
                                <img id="imgVcode" style="height: 48px" class="captchaImage" src="${path}/adminController/code">
                                <input style="width: 285px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="test" name="clientCode" id="form-code">
                            </div>
