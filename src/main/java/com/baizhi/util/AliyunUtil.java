...
public class AliyunUtil {
    ...
    //说明 有备注无需修改的位置请勿改动
     static SendSmsResponse queryPhone(String phoneNumbers, String signName, String templateCode, String templateParam )throws Exception{
        ...
        //替换成你的AK
        final String accessKeyId = "LTAI4G9yKvVdho9rzEBC9HZt";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "qy0QP3yrNGIH2egVbKPuHoPQm9YRrm";//你的accessKeySecret，参考本文档步骤2
    ...
    public static String sendPhoneMsg(String phoneNumbers,String code){
        ...
        try {
            ...
            String signName="思宇公众号";
            String templateCode="SMS_205611462";
    ...
    public static void main(String[] args) {
        String phoneNumbers="15035867021";
